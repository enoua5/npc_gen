...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'npc_gen.wast';
  var wasmBinaryFile = 'npc_gen.wasm';
  var asmjsCodeFile = 'npc_gen.temp.asm.js';
...
STATICTOP = STATIC_BASE + 19056;
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_npc_gen_cpp() } }, { func: function() { __GLOBAL__sub_I_bind_cpp() } });
...
Module['wasmTableSize'] = 512;

Module['wasmMaxTableSize'] = 512;
...
var real___GLOBAL__sub_I_npc_gen_cpp = asm["__GLOBAL__sub_I_npc_gen_cpp"]; asm["__GLOBAL__sub_I_npc_gen_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_npc_gen_cpp.apply(null, arguments);
};
...
var __GLOBAL__sub_I_npc_gen_cpp = Module["__GLOBAL__sub_I_npc_gen_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_npc_gen_cpp"].apply(null, arguments) };
